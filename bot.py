...
LINES_INFO = {
    ...
    18: ("Автостанция Орландовци", "Мелницата Чепинци"),
    20: ("Село Локорско", "Пл. Лъвов Мост"),
    21: ("Централна Гара", "Село Войнеговци"),
    22: ("Село Подгумер", "Централна Гара"),
    24: ("Кв. Бенковски", "Автостанция Орландовци"),
    27: ("МС. Княгиня Мария Луиза", "С. Кътина"),
    30: ("кв. Обеля", "Село Балша"),
    81: ("Северна Промишлена Зона", "Кв. Иваняне"),
    12: ("Автостанция Изток", "Село Долни Богоров"),
    29: ("Гара София Север", "Село Балша"),
...
LINE_GROUPS = {
    1: ["X9", "X10", 42, 63, 64, 83, 108, 111, 150, 260],
    2: [181, 183, 185, 26, 28, 68, 72, 98, 107, 280, 310, 78],
    7: [31, 18, 20, 21, 22, 24, 27, 30, 81, 12, 29, 86]
}
  #фИЛТЪР ЗА БУСОВЕТЕ
...
def get_allowed_lines_for_bus(bus):
    if 1000 <= bus <= 1999:
        ...
        return [31, 18, 20, 21, 22, 24, 27, 30, 81, 12, 29, 86]  # линии за автобуси 7000–7999
    else:
